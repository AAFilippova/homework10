...
from pet_products.models import ProductCategory, Product, Order, OrderProduct
...
class ProductFactory(DjangoModelFactory):
    ...
    animal_category = factory.Iterator(AnimalCategory.objects.all())
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        new_category = ProductCategoryFactory()
        self.stdout.write(self.style.SUCCESS(f"Category {new_category!r} created"))

        product = ProductFactory()
        self.stdout.write(
            self.style.SUCCESS(
                f"Product {product!r} with category {product.product_category!r} created",
            )
        )
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"New Product {product_with_new_category!r} with new category {product_with_new_category.product_category!r} created",
            ),
        )
